...
from gRNA_Mutation import gRNA_Mutation
...
def main():
    ...
    BasicFileUtils.create_log(tmpdir, curDate, 'Mutations')

    print("Producing guides for mutations ...")

    gRNA_mut = gRNA_Mutation(ifile, '.xlsx', ofile, tmpdir)
